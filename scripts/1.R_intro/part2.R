...
new_text <- readLines("samples/Doyle_Study_1887.txt")
head(new_text)
new_text1 <- paste(new_text, collapse = "\n")
my_second2_text <- strsplit(new_text1, " ")
my_second2_text
...
my_authors <- read.csv("samples/other_authors")
View(my_authors)
